...
var ToDoList = function (_React$Component) {
    ...
    _createClass(ToDoList, [{
        ...
        value: function componentDidMount() {
            ...
            this.fetchTasks();
            // fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=210").then(checkStatus).then(json).then((response) => {
        ...
        value: function fetchTasks() {
            ...
            fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=210").then(checkStatus).then(json).then(function (response) {
                console.log(response);
        ...
        value: function toggleComplete(id, completed) {
            ...
            fetch('https://altcademy-to-do-list-api.herokuapp.com/tasks/' + id + '/mark_' + newState + '?api_key=210', {
                method: "PUT",
                mode: "cors"
        ...
        value: function deleteTask(id) {
            ...
            fetch('https://altcademy-to-do-list-api.herokuapp.com/tasks/' + id + '?api_key=210', {
                method: "DELETE",
                mode: "cors"
            }).then(checkStatus).then(json).then(function (data) {
        ...
        value: function handleSubmit(event) {
            ...
            fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=210", {
                method: "POST",
                mode: "cors",
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement('input', { type: 'text', className: 'form-control mr-sm-2 mb-2', placeholder: 'new task', value: new_task, onChange: this.handleChange }),
                            React.createElement(
                                'button',
